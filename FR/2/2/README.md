...
1. Initialise le compas interne
...
2. Des formules mathématiques pour que le compas pointe vers la position GPS
...
3. Retourne la direction dans laquelle le micro:bit fait face, relativement à notre destination cible
...
5. Lance le programme du module GPS, comme dans l'activité précédente
...
6. Récupére la position GPS actuelle
...
7. Vérifie si nous sommes arrivés, et fait un son lorsque la destination est atteinte.
